        ...
        <>
            ...
            <nav className={` ${menu ? "block" : "hidden"}  w-screen md:block container bg-white text-center text-green-600 md:relative absolute`}>
                <ul className="grid md:grid-cols-5 text-3xl">
                    <NavLink className={({ isActive }) => (isActive ? "bg-green-600 p-12 text-white" : "p-12")} to={"/"}>Home</NavLink>
                    <NavLink className={({ isActive }) => (isActive ? "bg-green-600 p-12 text-white" : "p-12")} to={"/quienes-somos"}>Quienes somos</NavLink>
