        ...
        <>
            <form className='flex flex-col w-1/2 mx-auto'>
                ...
                <Link to={"/administracion"}>
                    <input className='mb-8 p-6 bg-lime-500 cursor-pointer outline-none text-white rounded-lg hover:bg-white hover:border transition-all hover:border-lime-500 hover:text-lime-500' type="submit" value="Ingresar al panel de administración" />
                </Link>
            </form>
        </>
    )
