    ...
    return (
      <div className="container">
        ...
        <div className="md:grid grid-cols-2 gap-8 items-center mt-36">
          <form
            id="formInit"
            className="flex flex-col border p-10 rounded-lg shadow-md"
            action=""
          >
          ...
          <div className="w-full h-full">
            <img
              src="https://res.cloudinary.com/dwvchf8al/image/upload/v1679113983/Demo_day_RROP/photo-1521737604893-d14cc237f11d_hapub4.jpg"
