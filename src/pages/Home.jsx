      ...
      <>
        <div className="w-full text-center">
          <div className="max-w-screen-lg m-auto">
            ...
            <p className="leading-10 px-10 md:px-0">
              {" "}
          ...
          <section className="relative">
            <h2 className=" mt-40 text-7xl font-bold mb-40 ">
          ...
          <section className="mb-40 ">
            <h2 className="mt-40 text-7xl font-bold mb-40 ">
              <span className="text-green-600">Eventos</span> <br /> más
              esperados.
            </h2>
          ...
          <section className="p-9">
            <h2 className="mt-40 text-7xl font-bold mb-40">
              <span className="text-green-600">Iniciativas</span> <br />a las
              que puedes postularte.
            </h2>
            <div className="container">
              <TipDayList />
            </div>
          ...
          <section className="container grid grid-cols-1 md:grid-cols-2 gap-28 p-20">
            <div>
              <h2 className="text-6xl text-left font-bold">
                {" "}
                <span className="text-green-600">Iniciativas</span> ambientales
              </h2>
              <p className="text-left">
                Inscríbete a nuestras iniciativas y recibe en tu correo
                electrónico nuestros próximos eventos y contenido exclusivo
