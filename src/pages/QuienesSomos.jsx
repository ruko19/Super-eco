    ...
    return (
        <div className="container flex flex-col mx-auto items-center justify-center">
            ...
            <div className="mt-24 md:w-1/2 font-light">
                <p className="mb-16"><span className="text-lime-500 font-bold">RROP</span> es una organizacion sin animo de lucro que se encarga de promover y de gestionar un mejor manejo de los residuos reciclables atravez de la educacion,
